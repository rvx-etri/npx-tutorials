...
input wire [BW_WDATA_INFO-1:0] dca_port_09;
...
input wire [BW_TENSOR_ROW-1:0] dca_port_01;
...
assign {dca_signal_11, dca_signal_10, dca_signal_07, dca_signal_09, dca_signal_01, dca_signal_05, dca_signal_00, dca_signal_03, dca_signal_06} = dca_port_09;
assign {dca_signal_12, dca_signal_02, dca_signal_04, dca_signal_08} = dca_port_16;

assign dca_port_08 = dca_port_14 & dca_port_03 & dca_port_11;

assign dca_port_15 = dca_port_03 & dca_port_04;
assign dca_port_16 = dca_port_05;

generate
for(i=0; i<MATRIX_NUM_COL; i=i+1)
begin : i_unformat
  assign dca_port_12[BW_LSU_ELEMENT*i+:BW_LSU_ELEMENT] = dca_port_01[BW_TENSOR_SCALAR*i+:BW_TENSOR_SCALAR];
end
endgenerate

assign dca_port_10 = dca_port_08 & dca_port_04;
assign dca_port_00 = dca_signal_02;
