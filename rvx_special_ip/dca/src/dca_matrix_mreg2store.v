...
input wire [DCA_LPARA_0-1:0] mreg_move_rdata_list1d;
...
reg [DCA_LPARA_1-1:0] dca_signal_1;

assign dca_signal_7 = store_tensor_row_rready & store_tensor_row_rvalid;
assign dca_signal_5 = dca_signal_7 | (dca_signal_1==DCA_LPARA_2);
assign dca_signal_4 = dca_signal_5 & dca_signal_2;
...
assign dca_signal_0 = clear | dca_signal_4;
assign dca_signal_3 = dca_signal_5;

always@(posedge clk, negedge rstnn)
begin
  if(rstnn==0)
    dca_signal_1 <= DCA_LPARA_3;
  else if(clear)
    dca_signal_1 <= DCA_LPARA_3;
  else if(enable)
  begin
...
assign mreg_move_renable = dca_signal_5;

assign store_tensor_row_rready = (dca_signal_1==DCA_LPARA_5);
assign store_tensor_row_rdata = mreg_move_rdata_list1d;

assign storereg_wready = (dca_signal_1==DCA_LPARA_3);
assign busy = (dca_signal_1!=DCA_LPARA_3);
