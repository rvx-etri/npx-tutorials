...
input wire [DCA_LPARA_4-1:0] dca_port_03;
output wire dca_port_46;
output wire dca_port_18;
input wire dca_port_40;
output wire dca_port_06;
output wire [DCA_LPARA_5-1:0] dca_port_11;
output wire [DCA_LPARA_1-1:0] dca_port_30;
...
input wire [BW_TENSOR_ROW-1:0] dca_port_23;
...
input wire [BW_TENSOR_ROW-1:0] dca_port_41;
...
wire dca_signal_12;
wire [DCA_LPARA_2-1:0] dca_signal_51;
wire dca_signal_23;
wire dca_signal_34;
wire dca_signal_44;
...
wire dca_signal_56;
wire [DCA_LPARA_2-1:0] dca_signal_58;
wire dca_signal_54;
wire [DCA_LPARA_2-1:0] dca_signal_63;
wire dca_signal_57;
wire dca_signal_10;
wire dca_signal_31;
...
wire dca_signal_24;
wire dca_signal_22;
wire [DCA_LPARA_2-1:0] dca_signal_13;
wire dca_signal_04;
wire [DCA_LPARA_2-1:0] dca_signal_55;
...
wire dca_signal_45;
wire dca_signal_28;
wire [DCA_LPARA_2-1:0] dca_signal_50;
wire dca_signal_39;
wire [DCA_LPARA_2-1:0] dca_signal_06;
wire [MATRIX_NUM_ELEMENT-1:0] dca_signal_37;
wire [BW_TENSOR_MATRIX-1:0] dca_signal_62;
wire [BW_TENSOR_MATRIX-1:0] dca_signal_03;

wire dca_signal_52;
wire [BW_TENSOR_SCALAR-1:0] dca_signal_18;
wire [BW_TENSOR_MATRIX-1:0] dca_signal_59;
wire [BW_TENSOR_ROW-1:0] dca_signal_02;

wire dca_signal_60;
wire dca_signal_46;
wire [BW_BLOCKED_STEP_INST-1:0] dca_signal_00;
wire dca_signal_08;
wire dca_signal_47;
wire dca_signal_30;
wire dca_signal_61;
...
(
  ...
  .dca_port_22(dca_port_00),
  .dca_port_21(dca_port_08),
  .dca_port_17(),

  .dca_port_20(dca_port_38),
  .dca_port_00(dca_port_03),
  .dca_port_10(dca_port_46),
  .dca_port_02(dca_signal_47),
  .dca_port_12(dca_signal_30),
  .dca_port_08(dca_signal_61),

  .dca_port_18(dca_signal_11),
  .dca_port_05(dca_signal_05),
  .dca_port_11(dca_signal_53),
  .dca_port_13(dca_port_01),
  .dca_port_16(dca_port_31),
  .dca_port_09(dca_port_26),
  .dca_port_03(dca_port_45),
  .dca_port_07(dca_port_27),
  .dca_port_01(dca_port_20),
  .dca_port_15(dca_port_44),
...
(
  ...
  .move_renable(dca_signal_12),
  .move_rdata_list(dca_signal_51),
  
  .shift_up(dca_signal_23),
  .shift_left(dca_signal_34),
  .transpose(dca_signal_44),
  
  .all_rdata_list2d(dca_signal_19),
  .upmost_rdata_list1d(dca_signal_40)
);

assign dca_signal_12 = 0;
assign dca_signal_44 = 0;
...
(
  ...
  .load_tensor_row_wvalid(dca_port_43),
  .load_tensor_row_wlast(dca_port_14),
  .load_tensor_row_wdata(dca_port_23),
...
(
  ...
  .move_wenable(dca_signal_56),
  .move_wdata_list(dca_signal_58),
  .move_renable(dca_signal_54),
  .move_rdata_list(dca_signal_63),
  
  .shift_up(dca_signal_57),
  .shift_left(dca_signal_10),
  .transpose(dca_signal_31),
  
  .all_rdata_list2d(dca_signal_09),
  .upmost_rdata_list1d(dca_signal_41)
);
...
(
  ...
  .mreg_move_wenable(dca_signal_56),
  .mreg_move_wdata_list1d(dca_signal_58),
...
(
  ...
  .load_tensor_row_wdata(dca_port_41),

  .mreg_move_wenable(dca_signal_22),
  .mreg_move_wdata_list1d(dca_signal_13),

  .loadreg_rready(dca_signal_43),
  .loadreg_rrequest(dca_signal_42)
);
...
(
  ...
  .storereg_wready(dca_signal_26),
  .storereg_wrequest(dca_signal_49),

  .mreg_move_renable(dca_signal_04),
  .mreg_move_rdata_list1d(dca_signal_55),

  .store_tensor_row_rvalid(dca_port_32),
  .store_tensor_row_rready(dca_port_33),
...
(
  ...
  .move_renable(dca_signal_39),
  .move_rdata_list(dca_signal_06),

  .all_wenable_list2d(dca_signal_37),
  .all_wdata_list2d(dca_signal_62),
  .all_rdata_list2d(dca_signal_03)
);
...
(
  ...
  .scalar_wenable(dca_signal_52),
  .scalar_wdata(dca_signal_18),
  
  .all_rdata_list2d(dca_signal_59),
  .upmost_rdata_list1d(dca_signal_02)
);

assign dca_signal_18 = dca_signal_41[BW_TENSOR_SCALAR-1-:BW_TENSOR_SCALAR];
...
(
  ...
  .dca_port_15(dca_port_08),
  .dca_port_16(dca_signal_60),

  .dca_port_11(dca_signal_46),
  .dca_port_22(dca_signal_00),
  .dca_port_01(dca_signal_08),

  .dca_port_09(dca_signal_19),
  .dca_port_17(dca_signal_23),
  .dca_port_10(dca_signal_34),
...
(
  ...
  .dca_port_15(dca_signal_07),

  .dca_port_06(dca_signal_35),
  .dca_port_22(dca_signal_01),
  ...
  .dca_port_21(dca_signal_43),
  .dca_port_11(dca_signal_42),
  .dca_port_23(dca_signal_26),
  .dca_port_01(dca_signal_26),
  .dca_port_19(dca_signal_49),
  .dca_port_09(dca_port_42),

  .dca_port_12(dca_signal_46),
  .dca_port_24(dca_signal_00),
  .dca_port_14(dca_signal_08),

  .dca_port_13(dca_signal_47),
  .dca_port_02(dca_signal_30),
  .dca_port_04(dca_signal_61),
  .dca_port_17(dca_port_18)
);

assign dca_port_06 = 0;
assign dca_port_11 = 0;
assign dca_port_30 = 0;
assign dca_port_22 = dca_port_38 | dca_signal_35 | dca_signal_07;
