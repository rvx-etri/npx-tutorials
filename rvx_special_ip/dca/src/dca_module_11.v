...
output reg [BW_MEMORY_ROW_BUFFER-1:0] dca_port_11;
...
wire [`BW_DCA_MATRIX_INFO_STRIDE_LS3-1:0] dca_signal_11;
...
assign {dca_signal_02, dca_signal_06, dca_signal_17, dca_signal_04, dca_signal_03, dca_signal_11, dca_signal_15, dca_signal_13, dca_signal_12} = dca_port_06;
assign {dca_signal_05, dca_signal_16, dca_signal_14, dca_signal_19} = dca_port_01;

assign dca_signal_01[BW_BITADDR_OFFSET-1:3] = LSU_SUPPORT_MULTIBYTE? dca_signal_19[BW_BITADDR-1:3] : 0;
assign dca_signal_01[2:0] = LSU_SUPPORT_SUBBYTE? dca_signal_19[2:0] : 0;

assign dca_signal_18 = dca_port_08 & dca_port_04;
assign dca_signal_09 = dca_port_07 & dca_port_02;
...
i_dca_instance_0
(
  .data_input(dca_signal_10),
  .shift_amount(dca_signal_08),
...
always@(posedge dca_port_00 or negedge dca_port_03)
begin
  if(dca_port_03==0)
  begin
    dca_port_11 <= 0;
...
assign dca_signal_00 = dca_signal_07;
...
assign dca_port_04 = dca_port_07? dca_port_02 : 1;
