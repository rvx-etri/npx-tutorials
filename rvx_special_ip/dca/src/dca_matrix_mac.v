...
localparam  DCA_LPARA_01 = `BW_DCA_MATRIX_MAC_LOG;
localparam  DCA_LPARA_09 = `BW_DCA_MATRIX_MAC_INST;
localparam  DCA_LPARA_00 = 32;
...
wire [(DCA_LPARA_02)-1:0] dca_signal_02;
wire [(DCA_LPARA_04)-1:0] dca_signal_08;
wire dca_signal_15;
wire dca_signal_14;
wire dca_signal_09;
wire dca_signal_10;
wire [(DCA_LPARA_01)-1:0] dca_signal_01;
wire dca_signal_05;
wire [(DCA_LPARA_09)-1:0] dca_signal_13;
wire dca_signal_04;
wire dca_signal_07;
wire dca_signal_16;
...
wire dca_signal_00;
wire dca_signal_12;
wire [(DCA_LPARA_03)-1:0] dca_signal_03;
...
(
  ...
  .smx_core_config(dca_signal_02),
  .smx_core_status(dca_signal_08),
  .smx_clear_request(dca_signal_15),
  .smx_clear_finish(dca_signal_14),
  .smx_core_log_wready(dca_signal_09),
  .smx_core_log_wrequest(dca_signal_10),
  .smx_core_log_wdata(dca_signal_01),
  .smx_inst_fifo_rready(dca_signal_05),
  .smx_inst_fifo_rdata(dca_signal_13),
  .smx_inst_fifo_rrequest(dca_signal_04),
  .smx_operation_finish(dca_signal_07),
  .smx_input_fifo_rready(dca_signal_16),
  .smx_input_fifo_rdata(dca_signal_11),
  .smx_input_fifo_rrequest(dca_signal_06),
  .smx_output_fifo_wready(dca_signal_00),
  .smx_output_fifo_wrequest(dca_signal_12),
...
(
  ...
  .control_rmx_core_config(dca_signal_02),
  .control_rmx_core_status(dca_signal_08),
  .control_rmx_core_log_wready(dca_signal_09),
  .control_rmx_core_log_wrequest(dca_signal_10),
  .control_rmx_core_log_wdata(dca_signal_01),
  .control_rmx_inst_fifo_rready(dca_signal_05),
  .control_rmx_inst_fifo_rdata(dca_signal_13),
  .control_rmx_inst_fifo_rrequest(dca_signal_04),
  .control_rmx_operation_finish(dca_signal_07),
  .control_rmx_input_fifo_rready(dca_signal_16),
  .control_rmx_input_fifo_rdata(dca_signal_11),
  .control_rmx_input_fifo_rrequest(dca_signal_06),
  .control_rmx_output_fifo_wready(dca_signal_00),
  .control_rmx_output_fifo_wrequest(dca_signal_12),
