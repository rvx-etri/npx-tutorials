...
wire [2-1:0] dca_signal_26;
wire dca_signal_15;
wire dca_signal_00;
wire dca_signal_11;
wire dca_signal_29;
wire [BW_LPI_QDATA-1:0] dca_signal_25;
wire [2-1:0] dca_signal_12;
wire dca_signal_07;
wire dca_signal_03;
wire dca_signal_17;
wire [BW_LPI_YDATA-1:0] dca_signal_24;
...
wire dca_signal_18;
wire dca_signal_28;
wire [BW_LPI_QDATA-1:0] dca_signal_22;
wire [2-1:0] dca_signal_10;
wire dca_signal_04;
wire dca_signal_09;
wire dca_signal_14;
wire [BW_LPI_YDATA-1:0] dca_signal_16;

wire dca_signal_27;
wire dca_signal_02;
wire dca_signal_21;
wire dca_signal_13;
wire [BW_LPI_QDATA-1:0] dca_signal_19;

wire [BW_LPI_QPARCEL-1:0] dca_signal_20;

wire dca_signal_08;

wire [BW_LPI_YPARCEL-1:0] dca_signal_05;
...
(
  ...
  .read_slqdready(dca_signal_26),
  .read_slqvalid(dca_signal_15),
  .read_slqhint(dca_signal_00),
  .read_slqlast(dca_signal_11),
  .read_slqafy(dca_signal_29),
  .read_slqdata(dca_signal_25),
  .read_slydready(dca_signal_12),
  .read_slyvalid(dca_signal_07),
  .read_slyhint(dca_signal_03),
  .read_slylast(dca_signal_17),
  .read_slydata(dca_signal_24),

  .write_slqdready(dca_signal_23),
  .write_slqvalid(dca_signal_06),
  .write_slqhint(dca_signal_30),
  .write_slqlast(dca_signal_18),
  .write_slqafy(dca_signal_28),
  .write_slqdata(dca_signal_22),
  .write_slydready(dca_signal_10),
  .write_slyvalid(dca_signal_04),
  .write_slyhint(dca_signal_09),
  .write_slylast(dca_signal_14),
  .write_slydata(dca_signal_16)
);

assign dca_signal_26 = (WRITE_SUPPORTED&dca_signal_01)? 0 : slxqdready;
assign dca_signal_23 = (WRITE_SUPPORTED&dca_signal_01)? slxqdready : 0;

assign dca_signal_27 = (WRITE_SUPPORTED&dca_signal_01)? dca_signal_06 : dca_signal_15;
assign dca_signal_02 = (WRITE_SUPPORTED&dca_signal_01)? dca_signal_30 : dca_signal_00;
assign dca_signal_21 = (WRITE_SUPPORTED&dca_signal_01)? dca_signal_18 : dca_signal_11;
assign dca_signal_13 = (WRITE_SUPPORTED&dca_signal_01)? dca_signal_28 : dca_signal_29;
assign dca_signal_19 = (WRITE_SUPPORTED&dca_signal_01)? dca_signal_22 : dca_signal_25;

assign slxqvalid = dca_signal_27;
assign slxqlast = dca_signal_21;
assign {slxqburden,dca_signal_20} = dca_signal_19;

assign {slxqwrite,slxqlen,slxqsize,slxqburst,slxqwstrb,slxqwdata,slxqaddr} = dca_signal_20;

assign dca_signal_08 = WRITE_SUPPORTED & slxywreply;

assign slxydready = dca_signal_08? dca_signal_10 : dca_signal_12;

assign dca_signal_07 = (~dca_signal_08) & slxyvalid;
assign dca_signal_03 = 0;
assign dca_signal_17 = slxylast;
assign dca_signal_24 = {slxyburden,dca_signal_05};

assign dca_signal_04 = (dca_signal_08) & slxyvalid;
assign dca_signal_09 = 0;
assign dca_signal_14 = slxylast;
assign dca_signal_16 = {slxyburden,dca_signal_05};

assign dca_signal_05 = {slxylast,slxywreply,slxyresp,slxyrdata};
