...
localparam  DCA_LPARA_3 = `BW_DCA_MATRIX_MAC_STATUS;
localparam  DCA_LPARA_1 = `BW_DCA_MATRIX_MAC_LOG;
...
wire dca_signal_7;
wire [DCA_LPARA_4-1:0] dca_signal_2;
wire dca_signal_5;
wire dca_signal_0;
wire dca_signal_4;
wire dca_signal_3;
wire [DCA_LPARA_1-1:0] dca_signal_1;
...
assign dca_signal_7 = control_rmx_inst_fifo_rready;
assign dca_signal_2 = control_rmx_inst_fifo_rdata;
...
(
  ...
  .dca_port_03(dca_signal_2),
  .dca_port_46(dca_signal_5),
  .dca_port_18(dca_signal_0),
  .dca_port_40(dca_signal_4),
  .dca_port_06(dca_signal_3),
  .dca_port_11(dca_signal_1),
  .dca_port_30(dca_signal_6),

  .dca_port_12(ma_sinst_busy),
  .dca_port_31(ma_sinst_wvalid),
  .dca_port_26(ma_sinst_wdata),
  .dca_port_01(ma_sinst_wready),
  .dca_port_28(ma_sinst_decode_finish),
  .dca_port_17(ma_sinst_execute_finish),
  .dca_port_15(ma_sload_tensor_row_wready),
  .dca_port_43(ma_sload_tensor_row_wvalid),
  .dca_port_14(ma_sload_tensor_row_wlast),
  .dca_port_23(ma_sload_tensor_row_wdata),

  .dca_port_24(mb_sinst_busy),
  .dca_port_27(mb_sinst_wvalid),
  .dca_port_20(mb_sinst_wdata),
  .dca_port_45(mb_sinst_wready),
  .dca_port_34(mb_sinst_decode_finish),
  .dca_port_13(mb_sinst_execute_finish),
  .dca_port_10(mb_sload_tensor_row_wready),
  .dca_port_36(mb_sload_tensor_row_wvalid),
  .dca_port_05(mb_sload_tensor_row_wlast),
  .dca_port_16(mb_sload_tensor_row_wdata),

  .dca_port_19(mc_sinst_busy),
  .dca_port_35(mc_sinst_wvalid),
  .dca_port_29(mc_sinst_wdata),
  .dca_port_44(mc_sinst_wready),
  .dca_port_39(mc_sinst_decode_finish),
  .dca_port_42(mc_sinst_execute_finish),
  .dca_port_09(mc_sload_tensor_row_wready),
  .dca_port_37(mc_sload_tensor_row_wvalid),
  .dca_port_25(mc_sload_tensor_row_wlast),
  .dca_port_41(mc_sload_tensor_row_wdata),
  .dca_port_32(mc_sstore_tensor_row_rvalid),
  .dca_port_33(mc_sstore_tensor_row_rready),
