...
localparam  DCA_LPARA_5 = `BW_DCA_MATRIX_MAC_STATUS;
...
input wire [(DCA_LPARA_7)-1:0] control_rmx_input_fifo_rdata;
...
localparam  DCA_LPARA_4 = MAKE_LSU_WRITE_ONLY(LSU_PARA);

wire dca_signal_02;
wire dca_signal_24;
wire [`BW_DCA_MATRIX_LSU_INST-1:0] dca_signal_40;
wire dca_signal_33;
wire dca_signal_34;
wire dca_signal_13;
...
wire dca_signal_38;
wire dca_signal_14;
wire [BW_TENSOR_ROW-1:0] dca_signal_22;

wire dca_signal_29;
wire dca_signal_39;
wire [`BW_DCA_MATRIX_LSU_INST-1:0] dca_signal_16;
wire dca_signal_35;
wire dca_signal_11;
wire dca_signal_25;
...
wire dca_signal_37;
wire dca_signal_09;
wire [`BW_DCA_MATRIX_LSU_INST-1:0] dca_signal_28;
wire dca_signal_10;
wire dca_signal_12;
wire dca_signal_26;
...
wire dca_signal_07;
wire dca_signal_23;
wire [BW_TENSOR_ROW-1:0] dca_signal_27;
...
(
  ...
  .inst_wvalid(dca_signal_24),
  .inst_wdata(dca_signal_40),
  .inst_wready(dca_signal_33),
  .inst_decode_finish(dca_signal_34),
  .inst_execute_finish(dca_signal_13),
  ...
  .load_tensor_row_wvalid(dca_signal_00),
  .load_tensor_row_wlast(dca_signal_21),
  .load_tensor_row_wdata(dca_signal_04),
  .load_tensor_row_wready(dca_signal_41),

  .store_tensor_row_rvalid(dca_signal_31),
  .store_tensor_row_rlast(dca_signal_38),
  .store_tensor_row_rready(dca_signal_14),
  .store_tensor_row_rdata(dca_signal_22)
);
...
(
  ...
  .inst_wvalid(dca_signal_39),
  .inst_wdata(dca_signal_16),
  .inst_wready(dca_signal_35),
  .inst_decode_finish(dca_signal_11),
  .inst_execute_finish(dca_signal_25),
  ...
  .load_tensor_row_wvalid(dca_signal_01),
  .load_tensor_row_wlast(dca_signal_15),
  .load_tensor_row_wdata(dca_signal_03),
  .load_tensor_row_wready(dca_signal_36),

  .store_tensor_row_rvalid(dca_signal_08),
  .store_tensor_row_rlast(dca_signal_17),
  .store_tensor_row_rready(dca_signal_30),
...
(
  ...
  .inst_wvalid(dca_signal_09),
  .inst_wdata(dca_signal_28),
  .inst_wready(dca_signal_10),
  .inst_decode_finish(dca_signal_12),
  .inst_execute_finish(dca_signal_26),
  ...
  .load_tensor_row_wvalid(dca_signal_05),
  .load_tensor_row_wlast(dca_signal_18),
  .load_tensor_row_wdata(dca_signal_06),
  .load_tensor_row_wready(dca_signal_32),

  .store_tensor_row_rvalid(dca_signal_19),
  .store_tensor_row_rlast(dca_signal_07),
  .store_tensor_row_rready(dca_signal_23),
  .store_tensor_row_rdata(dca_signal_27)
);
...
(
  ...
  .ma_sinst_wvalid(dca_signal_24),
	.ma_sinst_wdata(dca_signal_40),
	.ma_sinst_wready(dca_signal_33),
	.ma_sinst_decode_finish(dca_signal_34),
	.ma_sinst_execute_finish(dca_signal_13),
	.ma_sinst_busy(dca_signal_02),
	.ma_sload_tensor_row_wvalid(dca_signal_00),
	.ma_sload_tensor_row_wlast(dca_signal_21),
	.ma_sload_tensor_row_wdata(dca_signal_04),
	.ma_sload_tensor_row_wready(dca_signal_41),
	.ma_sstore_tensor_row_rvalid(dca_signal_31),
	.ma_sstore_tensor_row_rlast(dca_signal_38),
	.ma_sstore_tensor_row_rdata(dca_signal_22),
	.ma_sstore_tensor_row_rready(dca_signal_14),

  .mb_sinst_wvalid(dca_signal_39),
	.mb_sinst_wdata(dca_signal_16),
	.mb_sinst_wready(dca_signal_35),
	.mb_sinst_decode_finish(dca_signal_11),
	.mb_sinst_execute_finish(dca_signal_25),
	.mb_sinst_busy(dca_signal_29),
	.mb_sload_tensor_row_wvalid(dca_signal_01),
	.mb_sload_tensor_row_wlast(dca_signal_15),
	.mb_sload_tensor_row_wdata(dca_signal_03),
	.mb_sload_tensor_row_wready(dca_signal_36),
	.mb_sstore_tensor_row_rvalid(dca_signal_08),
	.mb_sstore_tensor_row_rlast(dca_signal_17),
	.mb_sstore_tensor_row_rdata(dca_signal_20),
	.mb_sstore_tensor_row_rready(dca_signal_30),

  .mc_sinst_wvalid(dca_signal_09),
	.mc_sinst_wdata(dca_signal_28),
	.mc_sinst_wready(dca_signal_10),
	.mc_sinst_decode_finish(dca_signal_12),
	.mc_sinst_execute_finish(dca_signal_26),
	.mc_sinst_busy(dca_signal_37),
	.mc_sload_tensor_row_wvalid(dca_signal_05),
	.mc_sload_tensor_row_wlast(dca_signal_18),
	.mc_sload_tensor_row_wdata(dca_signal_06),
	.mc_sload_tensor_row_wready(dca_signal_32),
	.mc_sstore_tensor_row_rvalid(dca_signal_19),
	.mc_sstore_tensor_row_rlast(dca_signal_07),
	.mc_sstore_tensor_row_rdata(dca_signal_27),
	.mc_sstore_tensor_row_rready(dca_signal_23)
);
