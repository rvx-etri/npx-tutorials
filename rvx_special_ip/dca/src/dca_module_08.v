...
input wire [BW_WDATA_INFO-1:0] dca_port_11;

output wire dca_port_00;
input wire dca_port_04;
input wire [BW_MEMORY_ROW_BUFFER-1:0] dca_port_09;
input wire [BW_TXN_INFO-1:0] dca_port_08;

input wire dca_port_13;
output wire dca_port_05;
output wire [BW_MEMORY_ROW_BUFFER-1:0] dca_port_02;
...
wire [BW_BITADDR_OFFSET-1:0] dca_signal_16;
...
localparam  DCA_LPARA_2 = BW_BITADDR_OFFSET;
...
assign {dca_signal_03, dca_signal_04, dca_signal_06, dca_signal_18, dca_signal_07, dca_signal_00, dca_signal_17, dca_signal_02, dca_signal_08} = dca_port_11;
assign {dca_signal_19, dca_signal_09, dca_signal_20, dca_signal_01} = dca_port_08;

assign dca_signal_16[BW_BITADDR_OFFSET-1:3] = LSU_SUPPORT_MULTIBYTE? dca_signal_01[BW_BITADDR-1:3] : 0;
assign dca_signal_16[2:0] = LSU_SUPPORT_SUBBYTE? dca_signal_01[2:0] : 0;
...
i_dca_instance_1
(
  .data_input(dca_signal_13),
  .shift_amount(dca_signal_05),
  .data_output(dca_signal_14)
);

assign dca_signal_13 = dca_port_09;
assign dca_signal_05 = dca_signal_16;

ERVP_BARREL_SHIFTER
#(
  .BW_DATA(DCA_LPARA_1),
  .BW_SHIFT_AMOUNT(DCA_LPARA_2),
  .SIGNED_AMOUNT(0),
  .PLUS_TO_LEFT(1),
  .ARITHMETIC_SHIFT(0),
  .CIRCULAR_SHIFT(0),
...
assign dca_signal_12 = $unsigned(dca_signal_08);
always@(*)
begin
  dca_signal_15 = 0;
  ...
  begin
    case(dca_signal_03)
      0:
        dca_signal_15[i] = dca_signal_12[i];
      1:
        dca_signal_15[i] = dca_signal_12[i>>1];
      2:
        dca_signal_15[i] = dca_signal_12[i>>2];
      3:
        dca_signal_15[i] = dca_signal_12[i>>3];
      4:
        dca_signal_15[i] = dca_signal_12[i>>4];
      5:
        dca_signal_15[i] = dca_signal_12[i>>5];
    endcase
  end
end
assign dca_signal_10 = dca_signal_16;

assign dca_port_00 = dca_port_13;
assign dca_port_05 = dca_port_04;
assign dca_port_02 = dca_signal_14;
assign dca_port_07 = dca_signal_11;
assign dca_port_03 = dca_port_08;
