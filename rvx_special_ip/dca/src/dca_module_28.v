...
wire [`BW_DCA_MATRIX_INFO_ADDR_LSA_P3-1:0] dca_signal_12;
...
assign {dca_signal_12, dca_signal_04, dca_signal_01, dca_signal_11, dca_signal_08, dca_signal_07, dca_signal_10, dca_signal_03, dca_signal_09} = dca_port_00;
assign {dca_signal_05, dca_signal_00, dca_signal_02, dca_signal_06} = dca_port_03;

assign dca_port_08 = dca_port_10;
assign dca_port_06 = dca_port_01;
assign dca_port_09 = dca_signal_00;

generate
for(i=0; i<MATRIX_NUM_COL; i=i+1)
begin : i_format
  assign dca_port_12[BW_TENSOR_SCALAR*i+:BW_TENSOR_SCALAR] = dca_signal_09[i]? dca_port_02[BW_LSU_ELEMENT*i+:BW_LSU_ELEMENT] : INVALID_TENSOR_VALUE;
end
endgenerate
